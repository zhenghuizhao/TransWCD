...
## Update
| :zap:        | Higher-performing TransWCD baselines with data augmentations have been released, with +2.47 F1 score on LEVIR-CD and +5.72 F1 score on DSIFN-CD compared to those mentioned in our paper. |
|--------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
##
